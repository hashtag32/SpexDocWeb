...
<main id="site-content" class="landing-page" role="main">
	...
	<div class="has-text-align-center zoom-1">
		<div class="site-logo faux-heading"><a href="https://dronorder.net/" class="custom-logo-link" rel="home"><img width="86" height="71" style="height: 71px;" src="https://dronorder.net/wp-content/uploads/2020/06/Dronorder_Logo_orange.png" class="custom-logo" alt="dronorder"></a><span class="screen-reader-text">DronOrder</span></div>
		<div class="site-description" style="color:black">Order a drone delivery flight</div><!-- .site-description -->
	</div>

	<h3 class="has-text-align-center zoom-1">Get updates on our project</h3>
	<div class="tnp tnp-subscription">
		<form method="post" action="https://dronorder.net/?na=s" onsubmit="return newsletter_check(this)">
			...
			<div class="tnp-field tnp-field-button button-wrap">
				<button class="smart-button" type="submit" value="subscription-button" value="Subscribe">
					Get them for free
				</button>
			</div>
		</form>
